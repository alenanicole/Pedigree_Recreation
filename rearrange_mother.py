...
def makeRelativeForOldPatient(originalPatient, fatherId, currentId):
    ...
    ET.SubElement(relationshipHolderNew, 'id', extension=str(fatherId))
...
def rearrange(tree, patientPerson):
    ...
    # This is done here to ensure that the original patient's father's ID has already been created
